...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "2025",
    endDate: "Present",
    title: "MSc Computer Science with Specialisation in Artificial Intelligence",
    company: "COCHIN UNIVERSITY OF SCIENCE AND TECHNOLOGY",
    description: [
      "Pursuing advanced studies in Computer Science with focus on Artificial Intelligence.",
      "Developing expertise in AI algorithms and machine learning techniques.",
      "Engaged in cutting-edge research and practical implementations.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    company: "SREE NARAYANA COLLEGE OF TECHNOLOGY",
    description: [
      "Completed comprehensive Computer Application degree with strong academic performance.",
      "CGPA – 8.5",
      "Developed foundational skills in web development and software engineering.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    startDate: "2019",
    endDate: "2022",
    title: "Secondary Education - A1 & A2 Grades",
    company: "SHARJAH INDIAN SCHOOL, U.A.E.",
    description: [
      "12th Grade: A2 (2021 – 2022)",
      "10th Grade: A1 (2019 – 2020)",
      "Developed strong fundamentals across diverse subjects and academic disciplines.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.NODEJS,
